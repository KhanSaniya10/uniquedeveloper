		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="login.php" id="our-location" class="btn-success" ><?php echo $_SESSION['username']; ?></a></li>
				</ul>
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"></a>
                <br><p>E-Learning is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>E-Learning</span><span>. </span><span>All Rights Reserved.</span></p></br>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>New Modikhana,411001</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">saniyakhan1912@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>Phone:</dt>
                <dd><a href="tel:#">+91 9625353553</a> <span>or</span> <a href="tel:#">+91 7736355331</a>
                </dd>
              </dl>
            </div>
