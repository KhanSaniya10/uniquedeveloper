...
<!-- ========================================================================================================================== -->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="../index.php">Disabled</a>
      </li>
    </ul>
...
<!-- ========================================================================================================================== -->
  ...
  <div class="container mt-4 col-md-10 position-relative">
    ...
    <h1 style="font-family: 'Arial', sans-serif;">Welcome <?php echo $_SESSION['username']; ?>, Let's start quiz</h1>
  ...
  <!-- tab content start -->
   ...
   <div class="tab-content">
     ...
     <center><button type="button" class="btn btn-success mt-5" href="#myid" data-toggle="collapse">Select Quiz</button></center>
