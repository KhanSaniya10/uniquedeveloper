					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
									You can ask regarding the issues.<br>we will solve that together for sure.
								</p>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												E-learning - A way to learn by yourself. <br>
												Here you can learn programming languages, Tech News and improve your coding skills.	
											</p>
										</div>
									</div>
								</div>
